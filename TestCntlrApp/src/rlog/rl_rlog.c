...
void rlCatchSegViolation(int sig)
{
   ...
   char **strings;
   char buf[RLOG_MAX_STACK_DEPTH * 128];
...
void logLevS(PSTR strLogLevel, PSTR modName, PSTR file, int lineno, PSTR fmtStr, PSTR str, ...)
{
   ...
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, str);
...
void logLevH(PSTR strLogLevel, PSTR modName, PSTR file, int lineno, PSTR fmtStr, PSTR hexdump, int hexlen, ...)
{
   ...
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, szHex);
             ...
             U32 splVal, U32 arg1, U32 arg2, U32 arg3, U32 arg4, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, g_splStr[splType], splVal,
              arg1, arg2, arg3, arg4);
...
void logLev0(PSTR strLogLevel, PSTR modName, PSTR file, int lineno, PSTR fmtStr, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel);
...
void logLev1(PSTR strLogLevel, PSTR modName, PSTR file, int lineno, PSTR fmtStr, U32 arg1, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, arg1);
...
void logLev2(PSTR strLogLevel, PSTR modName, PSTR file, int lineno, PSTR fmtStr, U32 arg1, U32 arg2, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, arg1, arg2);
             ...
             U32 arg1, U32 arg2, U32 arg3, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, arg1, arg2, arg3);
             ...
             U32 arg1, U32 arg2, U32 arg3, U32 arg4, ...)
{
   ...
   struct tm *tm = getTime(&microseconds);
   if (tm)
      fprintf(g_fp, fmtStr, TIME_PARAMS, modName, file, lineno, strLogLevel, arg1, arg2, arg3, arg4);
...
void getLogTimeStr(char *ts)
{
   ...
   if (tm)
      sprintf(ts, "%d_%d_%d_%d_%d_%d.%03d", tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday,
...
void createNewLogFile()
{
   ...
   char curTime[RLOG_MAX_TIME_STAMP];
   int fd;
   char *temptr;
...
#ifdef RLOG_ENABLE_TEXT_LOGGING
   // create single log file, rather than one based on timestamp. Create in current directory.
   sprintf(g_fileList[g_nCurrFileIdx], "./%s", g_fileName);
...
PUBLIC Void rlProcessLogBufFromL2(
    void *mBuf)
#else
PUBLIC Void rlProcessLogBufFromL2(mBuf) void *mBuf;
#endif
{
#ifndef RLOG_ENABLE_TEXT_LOGGING
   U32 logLength;
