...
PRIVATE S16 tfwAppReadConfigParams(Void)
{
   ...
   for (; !feof(fp);)
   {
      ...
      case TFW_IP_ADDR:
      {
         ...
         fwCb->tfwCfgCb.tfwIpAddr = CM_INET_HTON_U32(fwCb->tfwCfgCb.tfwIpAddr);
      }
      break;
      } /*End of switch */
...
PRIVATE S16 ueAppReadConfigParams(Void)
{
   ...
   for (; !feof(fp);)
   {
      ...
      case TRF_GEN_IP_ADDR:
      {
         ...
         fwCb->ueAppCfgCb.trfGenIPAddr = CM_INET_HTON_U32(fwCb->ueAppCfgCb.trfGenIPAddr);
      }
      break;
...
PRIVATE S16 nbAppReadConfigParams(Void)
{
   ...
   for (; !feof(fp);)
   {
      ...
      case ENB_IP_ADDR:
      {
         ...
         fwCb->nbAppCfgCb.enbIPAddr = CM_INET_HTON_U32(fwCb->nbAppCfgCb.enbIPAddr);
      }
      break;
      case MME_ID:
      {
      ...
      case MME_ADDR:
      {
         ...
         fwCb->nbAppCfgCb.mmeAddr = CM_INET_HTON_U32(fwCb->nbAppCfgCb.mmeAddr);
      }
      break;
      case SCTP_IP_ADDR:
      {
         ...
         fwCb->nbAppCfgCb.sctpIPAddr = CM_INET_HTON_U32(fwCb->nbAppCfgCb.sctpIPAddr);
      }
      break;
      case ENB_NAME:
      {
